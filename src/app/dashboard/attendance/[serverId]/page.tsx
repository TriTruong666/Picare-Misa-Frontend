...
import {
  ...
  useGetAttendanceDataByServer,
  useGetAttendanceEmployeeByServer,
...
export default function Page() {
  ...
  const { data: employees = [], isLoading: isLoadingAttendance } =
    useGetAttendanceEmployeeByServer(serverId as string, page, limit);
  const { data: attendanceData } = useGetAttendanceDataByServer(
    serverId as string,
    page,
    limit
  );
  ...
  const syncMutation = useMutation({
    mutationKey: ["sync-attendance-server", serverId],
